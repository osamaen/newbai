          ...
          <>
            ...
            >
              {id === 1 && (
                <>
                  <MenuItem
                    onClick={() => handleActionClick(2, params.row.id)}
                    disableRipple
                  >
                    <CheckCircleIcon />
                    Confirm
                  ...
                  <MenuItem
                    onClick={() => handleActionClick(5, params.row.id)}
                    disableRipple
                  >
                    <CancelIcon />
                    Cancel
              ...
              {id === 2 && (
                <MenuItem
                  onClick={() => handleActionClick(3, params.row.id)}
                  disableRipple
                >
                  <MeetingRoomIcon />
                  Check-In
              ...
              {id === 3 && (
                <MenuItem
                  onClick={() => handleActionClick(4, params.row.id)}
                  disableRipple
                >
                  <ExitToAppIcon />
                  Check-Out
